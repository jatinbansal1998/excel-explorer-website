...
export class ErrorHandler {
  ...
  private isRecoverable(type: ErrorType): boolean {
    return [ErrorType.FILTER_ERROR, ErrorType.CHART_ERROR].includes(type)
  }
...
export class BrowserCompatibility {
  ...
  private static checkModernFeatures(): boolean {
    return !!(Promise && Array.prototype.includes && Object.assign && window.fetch)
  }
...
export function useErrorHandler() {
  ...
  const handleError = useCallback(
    (error: Error, type: ErrorType, context?: Record<string, any>) => {
