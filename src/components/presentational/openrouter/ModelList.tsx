    ...
    return (
        <div className="border border-gray-200 rounded-md overflow-auto max-h-80">
            <div className="min-w-[1280px]">
                <div
                    className="grid grid-cols-[320px_160px_140px_140px_160px_140px_420px] px-3 py-1.5 text-xs font-bold text-gray-600 bg-gray-100 sticky top-0 z-10 uppercase tracking-wider border-b border-gray-200">
                    <div>Name</div>
                    <div>Provider</div>
