...
export default function PerformanceMonitorView({
    ...
    return (
        <div
            className="fixed bottom-4 right-4 z-50 w-96 max-h-[80vh] bg-white rounded-lg shadow-xl border border-gray-200">
            {/* Header */}
                    ...
                    {memoryUsage && (
                        <>
                            ...
                            <div>
                                ...
                                <p className={`text-sm font-medium ${highMemory ? 'text-red-600' : 'text-green-600'}`}>
            ...
            {expanded && (
                <div className="p-4 max-h-64 overflow-y-auto">
                    ...
                    {metrics.length > 0 ? (
                        ...
                        <p className="text-sm text-gray-500 text-center py-4">No performance metrics available</p>
                    )}
                            ...
                            <div className="space-y-2">
                                {summary.operations.map((op, index) => (
                                    <div key={index}
                                        ...
                                        <div className="text-right">
                                            <p className="text-sm font-medium text-blue-900">{formatTime(op.totalTime)}</p>
                                            <p className="text-xs text-blue-600">
