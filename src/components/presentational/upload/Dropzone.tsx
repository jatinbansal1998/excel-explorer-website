...
export function Dropzone({ isDragOver, acceptedTypes, maxSizeBytes }: Readonly<DropzoneProps>) {
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <span className="inline-flex items-center rounded-md bg-primary-600 px-5 py-2.5 text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
        Choose File
      </span>
